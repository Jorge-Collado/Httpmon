...
public class ConverterSpecies {
    ...
    public static OffsetDateTime parseDateTimeString(String str) {
        return ZonedDateTime.from(ConverterSpecies.DATE_TIME_FORMATTER.parse(str)).toOffsetDateTime();
    }
    ...
    public static OffsetTime parseTimeString(String str) {
        return ZonedDateTime.from(ConverterSpecies.TIME_FORMATTER.parse(str)).toOffsetDateTime().toOffsetTime();
    }
    ...
    private static void instantiateMapper(Object o) {
        ...
        module.addDeserializer(OffsetDateTime.class, new JsonDeserializer<OffsetDateTime>() {
            ...
            public OffsetDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
                ...
                return ConverterSpecies.parseDateTimeString(value);
            }
        });
