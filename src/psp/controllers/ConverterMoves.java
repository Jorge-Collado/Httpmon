...
// Import this package:
//
//     import psp.models.Converter;
//
// Then you can deserialize a JSON string with
//
//     PokemonList data = Converter.fromJsonString(jsonString);
...
public class ConverterMoves {
    ...
    public static OffsetDateTime parseDateTimeString(String str) {
        return ZonedDateTime.from(ConverterMoves.DATE_TIME_FORMATTER.parse(str)).toOffsetDateTime();
    }
    ...
    public static OffsetTime parseTimeString(String str) {
        return ZonedDateTime.from(ConverterMoves.TIME_FORMATTER.parse(str)).toOffsetDateTime().toOffsetTime();
    }
