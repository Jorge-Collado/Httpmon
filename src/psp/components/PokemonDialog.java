...
public class PokemonDialog extends javax.swing.JDialog {
    ...
    /**
     * Creates new form PokemonDialog
     */
    public PokemonDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PokemonDialog dialog = new PokemonDialog(new javax.swing.JFrame(), true);
